...
def parse_args():
    ...
    parser.add_argument('--trainset_dir', type=str, default='/SRdata/lhsDATA/datasets/data_for_training_p16_mins16_aug/SR_5x5_4x/')
    parser.add_argument('--testset_dir', type=str, default='/SRdata/lhsDATA/DATA/data_for_test/')
    ...
    parser.add_argument('--n_epochs', type=int, default=90, help='number of epochs to train')
...
def train(cfg, train_loader, test_Names, test_loaders):
    ...
    log_path = '/SRdata/lhsDATA/LFmanba_log/{}/'.format(cfg.model_name)
    ...
    for idx_epoch in range(epoch_state, cfg.n_epochs):
        ...
        if idx_epoch % 1 == 0:
            ...
            save_ckpt({
                ...
                'loss': loss_list, },
                save_path='/SRdata/lhsDATA/LFmanba_log/{}/checkpoints/'.format(cfg.model_name),
                filename=cfg.model_name + '_' + str(cfg.upscale_factor) + 'xSR_' + str(cfg.angRes) +
                         'x' + str(cfg.angRes) + '_epoch_' + str(idx_epoch + 1) + '.pth')
            loss_epoch = []
