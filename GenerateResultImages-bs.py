...
sourceDataPath = '/home/lhs/LF/LFTramba/source-NTIRE_Test' 
sourceDatasets = os.listdir(sourceDataPath)

resultsPath = '/SRdata/lhsDATA/bs/LFTramba/SR_5x5_4x/' 
SavePath = '/SRdata/lhsDATA/LFSRBS/LFTramba' 
angRes = 5
...
for datasetName in sourceDatasets:
    ...
    gtFolder = os.path.join(sourceDataPath, datasetName, 'inference') 
    ...
    for scene in sceneFiles:
        ...
        for u in range(U):
            for v in range(V):
                ...
                hr_SAI_CbCr = imresize(hr_SAI_CbCr, scalar_scale=4) 
